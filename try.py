...
class Player(tk.Frame):
    def __init__(self, master):
        ...
        self.current_theme = self.dark_theme  # Initial theme
        ...
        default_songs = [
            ...
            "Music/Bollywood/Banjara - Ek Villain.mp3",
        ...
        self.image_paths = ["images/aashiq tera.gif",
                            ...
                            "images/kabhi kabhi aditi.gif",
                            "images/khairiyat.gif",
                            "images/khalasi.gif",
        ...
        self.theme_switch_button = tk.Button(self.controls, text="Switch Theme", font=("times new roman", 12, "bold"),
                                             command=self.toggle_theme)
        self.theme_switch_button.grid(row=0, column=9, padx=6)
    ...
    def toggle_theme(self):
        ...
        # Update the theme for existing widgets
        for widget in self.winfo_children():
            widget.create_frames(**self.current_theme)
    ...
    def download_song(self, path):
        ...
        if destination:
            ...
            messagebox.showinfo("Song", "Song downloaded successfully.")
...
img = PhotoImage(file='images/dark-rider.gif')
